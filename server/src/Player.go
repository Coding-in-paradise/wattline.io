...
colors := [6]string["#ffe6f7", "#bf73ff", "#36badf","#08c96b","#f0dbb7","#beff11"]
const colorDefault = "purple"

func ColorsAreClose(color1 string, color2 string) bool
{
    threshold := 50
...
func randomColor() string {
    ...
    const randomNum = rand.Float64() * 255 * 255 * 255
    const color = "#" + math.floor(randomNum).
